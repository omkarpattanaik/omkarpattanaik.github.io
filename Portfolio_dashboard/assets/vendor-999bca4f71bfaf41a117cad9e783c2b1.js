...
return 2===arguments.length?(t=arguments[0],n=arguments[1],e=null):([e,t,i]=b(...arguments),void 0===i?n=0:o(n=i.pop())||(r=!0===n,n=i.pop())),[e,t,i,n=parseInt(n,10),r]}var _=0,w=0,R=0,O=0,E=0,A=0,S=0,T=0,k=0,C=0,P=0,j=0,M=0,x=0,D=0,N=0,F=0,I=0,z=0,L=0,U=0
...
this._platform=r(this._boundAutorunEnd)}get counters(){return{begin:w,end:R,events:{begin:O,end:0},autoruns:{created:I,completed:z},run:E,join:A,defer:S,schedule:T,scheduleIterable:k,deferOnce:C,scheduleOnce:P,setTimeout:j,later:M,throttle:x,debounce:D,cancelTimers:N,cancel:F,loops:{total:L,nested:U}}}get defaultQueue(){return this._defaultQueue}begin(){w++
var e,t=this.options,r=this.currentInstance
return!1!==this._autorun?(e=r,this._cancelAutorun()):(null!==r&&(U++,this.instanceStack.push(r)),L++,e=this.currentInstance=new f(this.queueNames,t),O++,this._trigger("begin",e,r)),this._onBegin(e,r),e}end(){R++,this._end(!1)}on(e,t){if("function"!=typeof t)throw new TypeError("Callback must be a function")
